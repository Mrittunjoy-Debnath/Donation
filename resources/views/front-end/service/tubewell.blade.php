...
@section('title','Donation || Tubewell')
@push('css')
...
@section('body')
    <div class="container">
        <hr>
        <h2 class="text-center mt-5">TubeWell && Sanitation</h2>
        <br>
        @php($i=1)
        @foreach($about as $row)
            @if($i%2==1)
                <div class="row mt-3">
                    <div class="col-md-6">
                        <img src="{{asset($row->aboutus_image)}}" width="80%" height="350px" style="border: 5px solid #eee; border-radius: 5px ;">
                    </div>
                    <div class="col-md-6">
