...
@section('body')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" action="{{ route('save-work') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Wrok Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="work_name" placeholder="Title ">
