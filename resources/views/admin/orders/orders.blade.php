...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        <div class="card">
            @php($i=1)
                            {{-- <div class="card-body"> --}}
                                <h4 class="card-title text-center p-2 bg-success">Request Orders Person</h4>
                                ...
                                class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="mx-3" href="{{ route('order-done',['order_id'=>$data->id,'customer_id'=>$data->customer_id]) }}">Show pdf</a>
                                            <a class="mx-3" href="{{ route('order-move',['order_id'=>$data->id,'customer_id'=>$data->customer_id]) }}">Done</a>
                                        </td>
                                    </tr>
                                    @endforeach
